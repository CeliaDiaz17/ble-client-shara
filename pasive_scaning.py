...
class PassiveBluetoothScanner:
    ...
    async def scan_devices(self, service_uuid="34d9a23f-2249-42a3-bb7e-6aa0640154a9", max_devices=3, scan_duration=20):
        self.data_list = [] #reinicio de la lista para que no se acumulen valores pasados
