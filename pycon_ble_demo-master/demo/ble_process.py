...
class BLEProcess(Process):
    ...
    def run(self) -> None:
        ...
        example_service.add_characteristic(
            "f76ce015-952b-c6a8-e17c-c2c19aac7b1b", ["read", "write"], "Answer first kid", "Option A"
        )
        
        example_service.add_characteristic(
            "6bebd2d4-5e0d-4fd3-8e58-5097a8e769fa", ["read", "write"], "Answer second kid", "Option A"
        )
        
        example_service.add_characteristic(
            "334f68a5-580e-4931-87e4-556241ae7b80", ["read", "write"], "Answer third kid", "Option B"
        )       
